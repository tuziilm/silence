...
import com.wxad.silence.common.RemarkForm;
import com.wxad.silence.common.SecurityUtils;
import com.wxad.silence.common.SystemUserType;
import com.wxad.silence.common.Query.NameQuery;
import com.wxad.silence.domain.SysUser;
import com.wxad.silence.service.SysUserService;
...
public class SysUserController extends CRUDController<SysUser, SysUserService, com.wxad.silence.mvc.SysUserController.SysUserForm, NameQuery>{
	...
	public static class SysUserForm extends RemarkForm<SysUser>{
        ...
        @Override
        public void silenceulateObj(SysUser sysUser) {
