...
<script>
    ...
    function buttonTest()
    {
    	...
    	//silence = gAnztVPN3meJcOzLsr65uUtdsFq1Y18NfQrOIN8OQ31pg64sGksVZCbR7JjHfwS+fMHJ2lVYn6TyD2l14rfHmooJ+Sr4Xo95lLrKPLiBHy0Q2VpkqJs\\/mVVmocOcoOVKD\\/JuwJwBnPeqYJtAOHqaQmkIp4rpfc+XGro67pjpMdmffyKfXvpQ5KIfDoMAC9TVQkwlZPSNKHm/EHD0HtVkF4R6bcZkTmVY
    	...
    	var data = {"data":"gAnztVPN3meJcOzLsr65uUtdsFq1Y18NfQrOIN8OQ31pg64sGksVZCbR7JjHfwS+fMHJ2lVYn6TyD2l14rfHmooJ+Sr4Xo95lLrKPLiBHy0Q2VpkqJs\\/mVVmocOcoOVKD\\/JuwJwBnPeqYJtAOHqaQmkIp4rpfc+XGro67pjpMdmffyKfXvpQ5KIfDoMAC9TVQkwlZPSNKHm/EHD0HtVkF4R6bcZkTmVY"}; 
    	 $.ajax({
    		 ...
    		 url: "${basePath}updatesilenceInfos",
    		 //url: "/downloadurl",
    		 data: data,
    		 dataType: 'json',
