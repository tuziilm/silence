...
<c:set var="_pageTitle" value="DeleteInfo列表" scope="request"/>
<c:set var="_underPushDelete" value="active" scope="request"/>
...
<!-- main content -->
		<div class="page-header"><h1>DeleteInfo列表</h1></div>
        <br/><br/>
		<div id="list">
		...
		<div class="row-fluid">
			<div class="span4 toolbar">
				<c:import url="../../theme/${_theme}/toolbar.jsp">
					<c:param name="create">${basePath}push/delete/create</c:param>
                    <c:param name="delete">${basePath}push/delete/delete</c:param>
					<c:param name="modify">${basePath}push/delete/modify</c:param>
				</c:import>
			</div>
