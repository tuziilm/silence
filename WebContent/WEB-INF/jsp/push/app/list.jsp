...
<!-- main content -->
		<div class="page-header"><h1>AppInfo列表</h1></div>
        <br/><br/>
		<div id="list">
		...
		<div class="row-fluid">
			<div class="span4 toolbar">
				<c:import url="../../theme/${_theme}/toolbar.jsp">
					<c:param name="create">${basePath}push/app/create</c:param>
                    <c:param name="delete">${basePath}push/app/delete</c:param>
					<c:param name="modify">${basePath}push/app/modify</c:param>
				</c:import>
			</div>
