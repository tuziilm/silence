...
<c:set var="_undersilence" value="active" scope="request"/>
<c:set var="_activesilenceInfo" value="active" scope="request"/>
<c:set var="_module" value="silenceInfo" scope="request"/>
